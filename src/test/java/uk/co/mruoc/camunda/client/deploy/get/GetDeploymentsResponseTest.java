...
class GetDeploymentsResponseTest {
    ...
    void shouldReturnNumberOfDeployments() {
        GetDeploymentsResponse response =
                GetDeploymentsResponseMother.build(DeploymentMother.build(), DeploymentMother.build());
    ...
    void shouldReturnIdsFromDeployments() {
        ...
        GetDeploymentsResponse response =
                GetDeploymentsResponseMother.build(DeploymentMother.withId(id1), DeploymentMother.withId(id2));
