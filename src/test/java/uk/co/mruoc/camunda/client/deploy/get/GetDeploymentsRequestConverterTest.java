...
class GetDeploymentsRequestConverterTest {
    ...
    private final GetDeploymentsRequestConverter converter =
            new GetDeploymentsRequestConverter(DEFAULT_BASE_URI, headerPopulator);
    ...
    void shouldReturnHttpRequestUsingDefaultBaseUriIfNoOverrideUriSpecifiedInRequest() {
        GetDeploymentsRequest request =
                GetDeploymentsRequestMother.builder().overrideBaseUri(null).build();
